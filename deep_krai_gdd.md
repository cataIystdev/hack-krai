# 🌿 KUDYTUDY — Global Design Document (GDD)
...
**КудыТуды** — PWA-платформа пространственного туризма (Spatial Tourism), которая:
...
> _«Представьте: вы говорите телефону "Я устал, хочу тишины и хорошего вина" — и через 10 секунд перед вами фотореалистичная 3D-экскурсия по частной винодельне в станице, о которой не знает даже Google. А фермер на другом конце провода не настраивал никакого сайта — он просто записал голосовое в мессенджер. Это КудыТуды — мост между путешественниками и скрытым Краснодарским краем, построенный на мультимодальном ИИ и Spatial Computing.»_
...
3. Транскрипция → **GPT-4o** с системным промптом:
   ```
   Ты — AI-профайлер туристической платформы КудыТуды. Проанализируй текст пользователя
...
2. **Уровень 2: Телефонный звонок** — Если не ответил за 5 мин → робо-звонок (Voximplant/Zadarma):
   ...
   > _«Иван Петрович, это КудыТуды. Сегодня к вам хотят приехать двое гостей. Нажмите 1 чтобы принять, нажмите 2 чтобы отклонить.»_
